...
type: cog [0.1]
name: cog-chatgpt
description: Provides ChatGPT through Codex CLI as an inseparable Model+Harness Cog.
version: "0.1.0"
license: Apache-2.0
publisher: OpenTeams
manifest: cog.yaml
...
Provides ChatGPT through Codex CLI as an inseparable Model+Harness Cog.

Composition: **model+harness**. Binding candidates require independent host admission.
